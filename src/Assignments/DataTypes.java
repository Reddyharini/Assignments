	...
	public static void main(String[] args) {
		// Temperature of a city in degrees Celsius: 25.5
		 ...
		 double temperatureInCelsius = 25.5;
	        System.out.println("Temperature of the city: " + temperatureInCelsius);
	        
	     // Whether a customer has placed an order: true or false
	        boolean hasPlacedOrder = true;
	        System.out.println("customer has placed? " + hasPlacedOrder );
	      ...
	      // Person's phone number: "123-456-7890"
	        ...
	        //11.Number of followers on a social media platform: 1,000,000
		        		long SocialMediaFollowers = 1000000;
